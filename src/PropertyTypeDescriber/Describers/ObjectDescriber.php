...
{
    public const SKIP_TYPES_CONTEXT = 'object_describer_skip_types';
    public const SKIP_BY_ATTRIBUTES_CONTEXT = 'object_describer_skip_by_attributes';
    ...
    {
        if (
            !array_key_exists(self::SKIP_BY_ATTRIBUTES_CONTEXT, $context)
            || !is_array($context[self::SKIP_BY_ATTRIBUTES_CONTEXT])
            || [] === $context[self::SKIP_BY_ATTRIBUTES_CONTEXT]
        ) {
            return false;
        }
        ...
        foreach ($context[self::SKIP_BY_ATTRIBUTES_CONTEXT] as $class) {
