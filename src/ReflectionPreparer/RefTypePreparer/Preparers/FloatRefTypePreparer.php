...
class FloatRefTypePreparer implements RefTypePreparerInterface
{
    /**
    ...
    {
        $propertyInfo = new Type(Type::BUILTIN_TYPE_FLOAT, $reflectionType->allowsNull());
    ...
    public function supports(ReflectionType $reflectionType): bool
    {
        ...
        return $reflectionType->getName() === Type::BUILTIN_TYPE_FLOAT;
    }
}
